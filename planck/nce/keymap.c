 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  GUI |      | Alt  | Lower| Bksp | Esc  | Enter| Space| Raise|      |  Up  |  GUI |
 * `-----------------------------------------------------------------------------------'
 */
[0] = {
  ...
  {KC_LGUI, _______, KC_LALT, M(1), KC_BSPC,  KC_ESC,  KC_ENT,   KC_SPC,M(2)   , _______, _______, KC_RGUI}
},
...
[1] = {
  ...
  {KC_LBRC, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,S(KC_NUHS),S(KC_NUBS),_______, _______,KC_RBRC},
...
[2] = {
  ...
  {KC_LCBR, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, _______, _______, KC_RCBR},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
},

/* Symbol Layer
 * ,-----------------------------------------------------------------------------------.
 * | RESET| Mprv | Mply | Mnxt | Wref |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 ...
 */
[3] = {
  {RESET,   KC_MPRV, KC_MPLY, KC_MNXT, KC_WREF, _______, _______, _______, _______, _______, _______, _______},
